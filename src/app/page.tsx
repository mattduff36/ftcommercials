        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-brand-grey-600 max-w-3xl mx-auto">
              State-of-the-art facilities and equipment to ensure your vehicles receive the highest
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-md p-8 transition-all duration-300 hover:shadow-lg">
              ...
              <p className="text-brand-grey-600 leading-relaxed mb-4">
                ...
                equipped workshop featuring newly installed inground brake rollers that ensure brake
                tests are carried out in line with Traffic Commissioner guidelines.
              </p>
            ...
            <div className="bg-white rounded-lg shadow-md p-8 transition-all duration-300 hover:shadow-lg">
              ...
              <p className="text-brand-grey-600 leading-relaxed mb-4">
                Our skilled technicians have a wide range of expertise covering all aspects of
                commercial vehicle maintenance and repair, ensuring your vehicles are safe,
      ...
      <section id="about" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-brand-grey-600 max-w-3xl mx-auto">
              F.T. Commercials LTD is your trusted partner for all HGV and commercial vehicle
              repairs and maintenance. Based in Newark, we operate a fully equipped 5-bay workshop
              with state-of-the-art facilities including inground brake rollers for comprehensive
              testing.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 transition-all duration-300 hover:shadow-lg">
            ...
            <p className="text-brand-grey-600 leading-relaxed mb-4">
              Our experienced technicians bring decades of combined expertise in commercial vehicle
              repairs and maintenance, with specialized knowledge across all aspects of HGV and
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <div className="text-center lg:text-left mb-8">
                <h3 className="text-2xl md:text-3xl font-bold text-brand-black-900 mb-4">
                  Send Us a Message
                </h3>
