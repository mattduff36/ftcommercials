      ...
      <div className="relative z-10 flex h-full items-center justify-center pb-24 md:pb-20">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div
              className={`mb-6 md:mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
            ...
            {/* Animated heading */}
            <h1
              className={`text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 md:mb-6 leading-tight transition-all duration-1000 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
              F.T. <span className="text-brand-accent animate-pulse-soft">Commercials</span> LTD
            </h1>
            <div
              className={`inline-block bg-brand-accent text-white text-sm md:text-base font-bold px-3 py-1 rounded-full mb-4 transition-all duration-1000 delay-200 ${
            ...
            {/* Animated subtitle */}
            <p
              className={`text-lg md:text-xl lg:text-2xl text-white mb-6 md:mb-8 max-w-2xl mx-auto transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
            ...
            {/* Animated buttons */}
            <div
              className={`flex flex-col sm:flex-row gap-3 md:gap-4 justify-center transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
              <button
                onClick={() => {
                ...
                className="group relative overflow-hidden flex items-center justify-center bg-brand-accent hover:bg-brand-accent-dark text-white px-6 md:px-8 py-3 md:py-4 font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
              >
              ...
              <button
                ...
                className="group relative overflow-hidden flex items-center justify-center border-2 border-white text-white hover:bg-white hover:text-brand-black-900 px-6 md:px-8 py-3 md:py-4 font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
              >
